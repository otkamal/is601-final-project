...
def fastapi_server():
    ...
    # Point the server at the test database (not settings.DATABASE_URL) so that
    # data written via e2e HTTP calls lands in the same database the
    # setup_test_database fixture drops/recreates each session.
